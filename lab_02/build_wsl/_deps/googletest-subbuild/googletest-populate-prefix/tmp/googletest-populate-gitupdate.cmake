...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-1.8.1"
  WORKING_DIRECTORY "/mnt/d/bmstu_coding/sem_04/beb/oop_labs/lab_02/build_wsl/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/d/bmstu_coding/sem_04/beb/oop_labs/lab_02/build_wsl/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/d/bmstu_coding/sem_04/beb/oop_labs/lab_02/build_wsl/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
